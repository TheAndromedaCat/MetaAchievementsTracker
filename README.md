...
| -------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Android  | ✅     | [<img src="https://storage.googleapis.com/docs.itch.ovh/brand/rf/assets/badges/badge_bw.png" alt="Avaialable on Itch.io" height="80">][itchio-myapp] <br/> [GitHub - apk][github-myapp]                                                                                                                                                                                                                                                                                                                                  |
