...
| -------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Android  | ✅     | [<img src="https://storage.googleapis.com/docs.itch.ovh/brand/rf/assets/badges/badge_bw.png" alt="Avaialable on Itch.io" height="80">][itchio-myapp] <br/> [<img src="https://raw.githubusercontent.com/Kunzisoft/Github-badge/main/get-it-on-github.png" alt="Get it on GitHub" height="80">][github-myapp]                                                                                                                                                                                                                                                                                                                                  |
